...
-- 3. Portfolio / Case Studies Table
...
-- 7. Client Inquiries / Leads Table
...
-- Idempotent RLS Policies (Drop if exists then recreate)
...
-- Seed Initial Data (Matching Layout.jpeg)
